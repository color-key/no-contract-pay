...
public class Sign {
     ...
     * @throws Exception
     */
    public static String appSign(long appId, String secretId, String secretKey, String bucketName) throws Exception {
        long now = System.currentTimeMillis() / 1000;
        long expired = Constats.EXPIRED.longValue();
